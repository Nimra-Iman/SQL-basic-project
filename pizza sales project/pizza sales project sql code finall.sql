...
-- Q: Join the necessary tables to find the total quantity of 
...
category;
-- Q: Group the orders by date and calculate the average number 
...
-- Q: Calculate the percentage contribution of each pizza type
-- to total revenue.
SELECT 
...
-- Q: Determine the top 3 most ordered pizza types based 
